...
-   [Zwinna praca](#zwinna-praca-agile)
    ...
    -   [Czemu zwinna praca?](#czemu-zwinna-praca)
    -   [Fundamentalne założenia Agile](#fundamentalne-założenia-agile)
    -   [Minimalizacja ryzyka, większa innowacja](#minimalizacja-ryzyka-większa-innowacja)
    -   [Czemu akurat SCRUM a nie inna implementacja?](#czemu-akurat-scrum-a-nie-inna-implementacja)
    -   [Stosowanie zasad dla zasady jest głupotą](#stosowanie-zasad-dla-zasady-jest-głupotą)
-   [SCRUM](#scrum)
    -   [Co to SCRUM?](#co-to-scrum)
    -   [Podstawowe założenia](#podstawowe-założenia)
    -   [Role w projekcie](#role-w-projekcie)
        -   [Właścicel Produktu (Product Owner)](#właścicel-produktu-product-owner)
        -   [Lider Zespołu (Scrum Master)](#lider-zespołu-scrum-master)
        -   [Zespół](#zespół)
    -   [Techniki](#techniki)
        -   [Sprint](#sprint-przepieg-cykl-iteracja)
        -   [Road mapa i kamienie milowe (mile stone)](#road-mapa-i-kamienie-milowe-mile-stone)
        -   [Rejestr Produktu (Product Backlog)](#rejestr-produktu-product-backlog)
        -   [Historyjki (User Story)](#historyjki-user-story)
        -   [Planowanie sprintu](#planowanie-sprintu)
        -   [Retrospektywa sprintu](#retrospektywa-sprintu)
        -   [Daily](#daily)
        -   [Tablica Agile](#tablica-agile)
    -   [Wdrożenie SCRUM'a](#wdrożenie-scruma)
